  ...
  o
    ...
    .on("click.bs.button.data-api", '[data-toggle^="button"]', (function (t) {
      ...
      if (
        ...
        "INPUT" !== n.tagName && "LABEL" === e.tagName || m
          ._jQueryInterface
          .call(o.default(e), "toggle", "INPUT" === n.tagName)
      }
    }))
    .on(
          ...
          return this.each((function () {
            ...
            if (n || (n = new t(
              ...
              "object" == typeof e
                ? e
                : null
            ), o.default(this).data("bs.dropdown", n)), "string" == typeof e) {
        ...
        t._dataApiKeydownHandler = function (e) {
          if (!(
            /input|textarea/i.test(e.target.tagName)
              ...
              : !I.test(e.which)
          ) && !this.disabled && !o.default(this).hasClass("disabled")) {
        ...
        l.forEach((function (t) {
          (function (t, e) {
            var n = t
              ...
              .toLowerCase();
            if (-1 !== e.indexOf(n))
              return -1 === F.indexOf(n) || Boolean(
                t.nodeValue.match(B) || t.nodeValue.match(H)
              );
        ...
        e.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            s.setAttribute("id", l),
              this
                .element
                .setAttribute("aria-describedby", l),
              this.setContent(),
            ...
            o
              ...
              o
                .default
                .contains(this.element.ownerDocument.documentElement, this.tip) || o
                  .default(s)
                  .appendTo(f),
              o
                .default(this.element)
    ...
    ft = function () {
      ...
      return e.show = function () {
        ...
        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && o.default(this._element).hasClass("active") || o.default(this._element).hasClass("disabled"))) {
          ...
          if (i) {
            var s = "UL" === i.nodeName || "OL" === i.nodeName
              ? "> li > .active"
              : ".active";
        ...
        e._transitionComplete = function (t, e, n) {
          ...
          if (
            ...
            if (a) {
              var s = []
                .slice
                .call(a.querySelectorAll(".dropdown-toggle"));
              o
                .default(s)
                .addClass("active")
            }
